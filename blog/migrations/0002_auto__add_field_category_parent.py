...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('blog_categories', 'parent', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='child', null=True, to=orm['blog.Category']), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Category.parent'
        db.delete_column('blog_categories', 'parent_id')
    ...
    models = {
        ...
        'blog.category': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'parent': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "'child'", 'null': 'True', 'to': "orm['blog.Category']"}),
