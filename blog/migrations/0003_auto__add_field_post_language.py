...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('blog_posts', 'language',
                      self.gf('django.db.models.fields.CharField')(default='fr', max_length=10),
                      keep_default=False)

        # Adding M2M table for field translations on 'Post'
        db.create_table('blog_posts_translations', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('from_post', models.ForeignKey(orm['blog.post'], null=False)),
            ('to_post', models.ForeignKey(orm['blog.post'], null=False))
        ))
        db.create_unique('blog_posts_translations', ['from_post_id', 'to_post_id'])


    def backwards(self, orm):
        # Deleting field 'Post.language'
        db.delete_column('blog_posts', 'language')

        # Removing M2M table for field translations on 'Post'
        db.delete_table('blog_posts_translations')
    ...
    models = {
        ...
        'blog.post': {
            ...
            'translations': ('django.db.models.fields.related.ManyToManyField', [], {'blank': 'True', 'related_name': "'translations_rel_+'", 'null': 'True', 'to': "orm['blog.Post']"})
        },
